...
namespace Karty__Idz_na_ryby
{
    class Game
    {
        ...
        {
            Values cardToAskFor = players[0].Peek(selectedPlayerCard).Values;
        ...
        {
            // przegląda rękę gracza, by sprawdzic czy posiada 4 karty tej samej wartosci, jesli TAK zostaja dodane do slownika BOOKS
            //Jezeli po tym gracz nie ma kart zwraca TRUE
        ...
        {
            //zmienia elementy słownika na słowa
            string describe = "";
            foreach (Values value in books.Keys)
            {
                describe += books[value].Name + " ma grupe " + Card.Plural(value, 0) + Environment.NewLine;
            }
            return describe;
        }
